...
- Q:连接中无序的帧是如何依据流 ID 重组成流的
    ...
    - ![](https://img.shiqi-lu.tech/20210324075750.png)
    - ![](https://img.shiqi-lu.tech/20210324075756.png)
...
- Q:HTTP/2如何根据帧的标志位实现流状态转换
    - ![](https://img.shiqi-lu.tech/20210324080322.png)
    - 最开始的时候流都是空闲(idle)状态
...
- Q:不同HTTP协议栈图的对比
    - ![](https://img.shiqi-lu.tech/20210324100732.png)
- Q:QUIC有什么特点？
...
- Q:QUIC内部介绍
    ...
    - ![](https://img.shiqi-lu.tech/20210324103531.png)
    ...
    - ![](https://img.shiqi-lu.tech/20210324103702.png)
