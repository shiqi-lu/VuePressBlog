...
## 第三部分：传输层
- Q:三次握手
    - ![](https://img.shiqi-lu.tech/20210220115326.png)
...
- Q:四次挥手
    - ![](https://img.shiqi-lu.tech/20210220121011.png)
...
- Q:TCP 和 UDP 的区别
    - ![](https://img.shiqi-lu.tech/20210220163423.png)
- Q:TCP协议中的7种定时器
...
- Q:TCP 的停止等待协议是什么
    ...
    - 1.无差错传输
        - ![](https://img.shiqi-lu.tech/20210220172913.png)
        - A 发送分组 Msg 1，发完就暂停发送，直到收到接收方确认收到 Msg 1 的报文后，继续发送 Msg 2，以此类推，该情形是通信中的一种理想状态
    - 2.出现差错
        - ![](https://img.shiqi-lu.tech/20210220173007.png)
