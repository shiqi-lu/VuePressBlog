...
- 详细过程
    - 1.CanCommit阶段
        ...
        - ![](https://img.shiqi-lu.tech/20210225155731.png)
    - 2.PreCommit阶段
        ...
        - ![](https://img.shiqi-lu.tech/20210225155951.png)
    - 3.DoCommit阶段
        ...
        - ![](https://img.shiqi-lu.tech/20210225160141.png)
...
- 转账的场景说明
    ...
    - ![](https://img.shiqi-lu.tech/20211205174706.png)
- 场景的技术难点
...
- 实现方案 1：业务方实现，例如使用 kafka，消息中间件没有提供「事务消息」功能
    - 步骤
        - ![](https://img.shiqi-lu.tech/20211205175446.png)
...
- 实现方案 2：基于 RocketMQ 事务消息
    ...
    - 步骤
        - ![](https://img.shiqi-lu.tech/20211205181411.png)
